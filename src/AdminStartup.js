...
class Admin extends Component {
    ...
    async submit() {
        if(this.state.file != '') {
            ...
            let res = await axios.post(`${connection.protocol}://${connection.serverphp}/startupph/addEvents.php`, data, {crossdomain: true})
            alert(res.data)
    ...
    async delete(e) {
        let res = await axios.get(`${connection.protocol}://${connection.serverphp}/startupph/deleteEvents.php?id=${e.target.name}&pass=${this.state.password}`)
        if(res){
            alert(res.data)
            this.getEvents()
        }
    ...
    async update() {
        if(this.state.file != '') {
            ...
            data.append('desc', this.state.descrption);
            data.append('file', this.state.file);
            let res = await axios.post(`${connection.protocol}://${connection.serverphp}/startupph/updateEvents.php`, data, {crossdomain: true})
            alert(res.data)
